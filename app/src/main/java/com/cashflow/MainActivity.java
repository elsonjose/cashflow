                ...
                popupMenu.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
                    ...
                    public boolean onMenuItemClick(MenuItem menuItem) {
                        ...
                        switch (menuItem.getItemId()) {
                            case R.id.income: {
                                startActivity(new Intent(MainActivity.this, CashFlowActivity.class).putExtra("type", "income"));
                                overridePendingTransition(android.R.anim.fade_in, android.R.anim.fade_out);
                                finish();
                                break;
                            }
                            default: {
                                startActivity(new Intent(MainActivity.this, CashFlowActivity.class).putExtra("type", "expense"));
                                overridePendingTransition(android.R.anim.fade_in, android.R.anim.fade_out);
                                finish();
                            }
                        }
            ...
            public void onClick(View view) {
                ...
                popupMenu.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
                    ...
                    public boolean onMenuItemClick(MenuItem menuItem) {
                        ...
                        statementFragment.loadStatement();
                        return true;
                    }
                });
                popupMenu.show();
